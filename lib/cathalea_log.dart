...
import 'package:gardening_app/cathalea_report.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: CathaleaLog(),
      routes: {
        '/reportcathalea': (context) => CathaleaReport(),
      },
      onGenerateRoute: (settings) {
        if (settings.name == '/reportcathalea') {
          return MaterialPageRoute(
            builder: (context) => CathaleaReport(),
          );
        }
        return null;
      },
...
class CathaleaLog extends StatefulWidget {
  const CathaleaLog({Key? key}) : super(key: key);

  @override
  _CathaleaLogState createState() => _CathaleaLogState();
}

class _CathaleaLogState extends State<CathaleaLog> {
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => CathaleaReport()),
                      );
                    },
                    child: Container(

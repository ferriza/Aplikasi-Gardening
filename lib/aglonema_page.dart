...
import 'package:gardening_app/aglonema_log.dart';
...
class AglonemaPage extends StatefulWidget {
  @override
  _AglonemaPageState createState() => _AglonemaPageState();
}

class _AglonemaPageState extends State<AglonemaPage> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Center the "Aglonema" text and image
              Align(

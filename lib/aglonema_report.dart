  ...
  class AglonemaReport extends StatefulWidget {
    @override
    _AglonemaReportState createState() => _AglonemaReportState();
  }

  class _AglonemaReportState extends State<AglonemaReport> {
    ...
    void fetchData() async {
      ...
      if (snapshot.snapshot.value != null) {
        ...
        logData = Map.fromEntries(
            logData.entries.toList()..sort((e1, e2) => e1.value['timestamp'].compareTo(e2.value['timestamp'])));

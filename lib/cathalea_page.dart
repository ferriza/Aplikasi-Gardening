...
import 'package:gardening_app/cathalea_log.dart';
...
class CathaleaPage extends StatefulWidget {
  @override
  _CathaleaPageState createState() => _CathaleaPageState();
}

class _CathaleaPageState extends State<CathaleaPage> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Center the "Cathalea" text and image
              Align(

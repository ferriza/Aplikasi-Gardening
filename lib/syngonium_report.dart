...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'My App',
      home: SyngoniumReport(),
    );
  }
}

class SyngoniumReport extends StatefulWidget {
  @override
  _SyngoniumReportState createState() => _SyngoniumReportState();
}

class _SyngoniumReportState extends State<SyngoniumReport> {
